// Local smoke test / minimal CLI for GraphEngine (graph_engine.h): prefills a
...
// prefill/forward/gather/reset round-trip correctly on the local machine,
// without a target server.
#include <algorithm>
#include <cstdio>
#include <cstdlib>
#include <optional>
